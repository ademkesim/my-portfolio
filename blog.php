    ...
    <div class="banner_inner d-flex align-items-center">
       ...
       <div class="container">
           <div class="blog_b_text text-center">
              <h2 style="font-style: italic; ">Welcome to Blog</h2>
          </div>
      </div>
  </div>
</section>
                ...
                <div class="blog_left_sidebar">
                    ...
                    if (isset($_GET['blog_id'])) {
                                   ...
                                   // toplam sayfa sayımızdan fazla yazılırsa en son sayfayı varsayalım.
                                        ...
                                        $blogsor=$db->prepare("SELECT blog.* FROM blog WHERE blog_durum=:blog_durum order by tarih DESC limit $limit,$sayfada");
                                        ...
                                        if ($say==0) {
                                            echo "Bu blogda ürün Bulunamadı";
                                        }
                                   ...
                                   // toplam sayfa sayımızdan fazla yazılırsa en son sayfayı varsayalım.
                                        ...
                                        $blogsor=$db->prepare("SELECT blog.baslik,blog.icerik,blog.dil,blog.blog_id,blog.blog_durum,blog.blog_onecikar,blog.tarih FROM blog WHERE blog_durum=:blog_durum  order by tarih DESC limit $limit,$sayfada");
                                        $blogsor->execute(array(
                                            'blog_durum' => 1
                                        ));
                                    ...
                                    while($blogcek=$blogsor->fetch(PDO::FETCH_ASSOC)) {                     
                                        ...
                                        while ($s < $toplam_sayfa) {
                                            ...
                                            if ($s==$sayfa) {?>  
                                                ...
                                                <li class="page-item active"><a href="blog.php?sayfa=<?php echo $s; ?>" class="page-link"><?php echo $s; ?></a></li>
                                            <?php } else {?>
                                                <li class="page-item"><a href="blog.php?sayfa=<?php echo $s; ?>" class="page-link"><?php echo $s; ?></a></li>
                                            <?php   }
