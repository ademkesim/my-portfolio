...
if (isset($_POST['magazaurunekle'])) {
	...
	$duzenle=$db->prepare("INSERT INTO urun SET
		...
		urun_kaparo=:urun_kaparo,
		urun_tarih=:urun_tarih,
		urun_fiyat=:urun_fiyat,
		urun_il=:urun_il,
		urun_ilce=:urun_ilce,
		urun_adres=:urun_adres,
	...
	$update=$duzenle->execute(array(
		...
		'urun_tarih' => htmlspecialchars($_POST['urun_tarih']),
		'urun_kaparo' => htmlspecialchars($_POST['urun_kaparo']),
		'urun_il' => htmlspecialchars($_POST['urun_il']),
		'urun_ilce' => htmlspecialchars($_POST['urun_ilce']),
		'urun_adres' => htmlspecialchars($_POST['urun_adres']),
